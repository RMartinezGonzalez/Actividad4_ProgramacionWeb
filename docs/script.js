...
const errorMessages = {
  name: {
    ...
    patternMismatch: 'Ingresa solo letras',
  },
  email: {
    valueMissing: 'Ingresa tu emanl',
    typeMismatch: 'Email invalido',
    patternMismatch: 'Ejemplo: name@mail.com',
  },
  subject: {
    valueMissing: 'Ingresa el titulo',
  },
  message: {
    valueMissing: 'Ingresa tu mensaje',
  },
};
